    ...
    const fillFormWithGoogleData = useGoogleLogin({
        onSuccess: async (tokenResponse) => {
            ...
            try {
                ...
                console.log("Dados do Google recebidos:", userInfo);
                ...
                // Focar no campo de telefone após preencher com Google
                setTimeout(() => {
            ...
            <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
                <div>
                    ...
                    <div>
                        ...
                        {isGoogleLoading && (
                            <div className="p-3 mt-3 text-sm text-blue-800 bg-blue-100 rounded-lg dark:bg-blue-900/30 dark:text-blue-400">
                                🎯 Obtendo seus dados do Google...
                            </div>
                        )}
                  ...
                  Or
                      ...
                      {showPassword ? (
                          ...
                          <EyeCloseIcon className="fill-gray-500 dark:fill-gray-400 size-5" />
                                    ...
                                    <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                        Mesmo usando Google, você precisa criar uma senha para sua conta.
                                    </p>
                                </div>
