...
export default function SignInForm() {
  ...
  const { login, loginWithGoogle, loginWithPhone, sendVerificationCode, isLoading } = useAuth();
            ...
            <form onSubmit={handleSubmitEmail(onSubmitEmail)}>
              <div className="space-y-6">
                <div>
                  ...
                  />
                  {errorsEmail.email && (
                    <p className="mt-1 text-sm text-error-500">{errorsEmail.email.message}</p>
                  )}
                </div>
                <div>
                  <Label>
                  ...
                  {errorsEmail.password && (
                    <p className="mt-1 text-sm text-error-500">{errorsEmail.password.message}</p>
                  )}
                </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  {errorsWhatsApp.phone && (
                    <p className="mt-1 text-sm text-error-500">{errorsWhatsApp.phone.message}</p>
                  )}
                ...
                {verificationSent && (
                  <div>
                    ...
                    {errorsWhatsApp.code && (
                      <p className="mt-1 text-sm text-error-500">{errorsWhatsApp.code.message}</p>
                    )}
