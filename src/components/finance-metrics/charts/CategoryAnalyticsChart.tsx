        ...
        const loadCategoryData = async () => {
            try {
                ...
                transactions.forEach(transaction => {
                    const categoryName = transaction.categoryId ? `Categoria ${transaction.categoryId}` : 'Sem categoria';
                ...
                donut: {
                    ...
                    labels: {
                        ...
                        value: {
                            ...
                            fontWeight: 'bold',
                            color: '#111827',
                            formatter: (val) => `R$ ${parseFloat(val).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}`,
                        },
                        total: {
                            show: true,
                            label: 'Total',
