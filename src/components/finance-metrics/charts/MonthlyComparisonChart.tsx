                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-semibold text-green-800 dark:text-green-200">
                                R$ {chartData.income.reduce((a, b) => a + b, 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg font-semibold text-red-800 dark:text-red-200">
                                R$ {chartData.expense.reduce((a, b) => a + b, 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className={`text-lg font-semibold ${
                                chartData.income.reduce((a, b) => a + b, 0) - chartData.expense.reduce((a, b) => a + b, 0) >= 0
                                    ? 'text-green-600 dark:text-green-400'
                                    : 'text-red-600 dark:text-red-400'
                            }`}>
                                R$ {(chartData.income.reduce((a, b) => a + b, 0) - chartData.expense.reduce((a, b) => a + b, 0)).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </p>
                        </div>
                    </div>
                </div>
