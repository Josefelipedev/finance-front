...
const TrendAnalyticsChart: React.FC<TrendAnalyticsChartProps> = ({ dateRange }) => {
    ...
    const avgDailyBalance = trendData.balance.length > 0
    ...
    const balanceChangePercent = firstBalance !== 0 ? (balanceChange / Math.abs(firstBalance)) * 100 : 0;
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className={`text-lg font-semibold ${
                                ...
                                {balanceChange >= 0 ? '+' : ''}R$ {balanceChange.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
