                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Baseado na sua análise {activeChart === 'monthly' ? 'mensal' : activeChart === 'category' ? 'por categoria' : 'de tendência'},
                            {activeChart === 'monthly' ? ' recomenda-se manter um equilíbrio entre receitas e despesas.' :
                                activeChart === 'category' ? ' considere revisar as categorias com maior gasto.' :
