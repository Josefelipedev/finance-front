// src/components/finance-metrics/categories/CategoryManager.tsx
...
const CategoryManager: React.FC = () => {
  ...
  const onToggleStatus = async (category: FinanceCategory) => {
    const updatedStatus = !category.isActive;
    const updateApi = useFinanceCategory();
    await updateApi.updateCategory(category.id, { isActive: updatedStatus });
