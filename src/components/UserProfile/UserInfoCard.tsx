...
import { useUserProfile } from '../../hooks/useUserProfile'; // Ajuste o caminho
...
export default function UserInfoCard() {
  ...
  // Carregar o perfil ao montar o componente
  useEffect(() => {
    getProfile();
  }, []);

  // Quando o perfil for carregado, preencher o formulário
  useEffect(() => {
    if (profile) {
      setFormData({
