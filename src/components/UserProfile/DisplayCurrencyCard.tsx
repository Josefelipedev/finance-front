...
const DisplayCurrencyCard: React.FC = () => {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-white/[0.06] dark:bg-slate-800 lg:p-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <select
          ...
          className="rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-brand-400/40 disabled:opacity-60 dark:border-white/[0.08] dark:bg-slate-700 dark:text-white"
        >
